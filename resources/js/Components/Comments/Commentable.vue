...
<template>
  <div class="mt-4">
    ...
    <button @click="toggleOpen" class="flex items-center space-x-2 focus:outline-none">
      <Icon icon="mdi:comment-outline" class="w-6 h-6 text-gray-600 hover:text-gray-800" />
