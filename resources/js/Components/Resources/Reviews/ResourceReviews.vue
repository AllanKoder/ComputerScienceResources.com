      ...
      >
        <div class="flex justify-between items-center mb-4">
          ...
          <div class="flex items-center">
            ...
            <Rating :modelValue="calculateAverageRating(review)" readonly :cancel="false" />
          </div>
        </div>
        <p class="text-gray-700 mb-4 whitespace-pre-line">{{ review.description }}</p>
        ...
        <div class="mt-4">
          <button @click="toggleExpand(review.id)" class="text-blue-500 underline">
        ...
        <div v-if="expandedReviews[review.id]" class="mt-4 border-t pt-4">
          <div class="flex flex-wrap gap-4 justify-between">
            ...
            >
              ...
              <Rating :modelValue="review[feature.key]" readonly :cancel="false" />
            </div>
          </div>
        </div>
      </div>
